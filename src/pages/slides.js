...
2. Numbered point 2"
            ...
            <div className="mb-6">
              <div className="border-t border-b border-gray-200 py-4">
                <h3 className="font-medium mb-2">Option 1: Submit directly</h3>
                <p className="text-sm text-gray-600 mb-4">
                  Submit your content and our AI will format it into slides for
                  you.
                </p>
